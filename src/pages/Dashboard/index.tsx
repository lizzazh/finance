        ...
        <>
          <div className="hero-card text-white flex flex-col gap-4 rounded-2xl p-5 md:p-6 shadow-md relative overflow-hidden">
            ...
            <div className="flex flex-col gap-2 pt-4 border-t border-white/20 relative z-10">
              <div className="flex justify-between items-center gap-3 bg-white/10 rounded-lg px-3 py-2.5">
                <span className="text-sm font-medium opacity-90 leading-tight flex-1">Свободно после обязательных</span>
                <span className="font-bold text-lg whitespace-nowrap shrink-0">{formatAmount(availableBalance, currentBalance.baseCurrency)}</span>
              </div>
              <div className="flex justify-between items-center gap-3 bg-white/10 rounded-lg px-3 py-2.5">
                <span className="text-sm font-medium opacity-90 leading-tight flex-1">Свободно после накоплений</span>
                <span className="font-bold text-lg text-emerald-200 whitespace-nowrap shrink-0">{formatAmount(availableAfterSavings, currentBalance.baseCurrency)}</span>
              </div>
            </div>
          </div>
